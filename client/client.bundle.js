/******/ (() => {
  ...
  /******/ var __webpack_modules__ = {
    /***/ "./node_modules/bpmn-js-embedded-comments/dist/index.esm.js":
      /*!******************************************************************!*\
  !*** ./node_modules/bpmn-js-embedded-comments/dist/index.esm.js ***!
  \******************************************************************/
      /***/ (
        ...
        function Comments(eventBus, overlays, bpmnjs) {
          ...
          function createCommentBox(element) {
            ...
            function renderComments() {
              ...
              comments.forEach(function (val) {
                var $comment = jquery__WEBPACK_IMPORTED_MODULE_0___default()(
              ...
              $overlay[comments.length ? "addClass" : "removeClass"](
                "with-comments",
              );
              $commentCount.text(
          ...
          eventBus.on("shape.added", function (event) {
            ...
            if (
              element.labelTarget ||
              !element.businessObject.$instanceOf("bpmn:IntermediateThrowEvent")
            ) {
              return;
            }
      ...
      /***/ (
        ...
        /* harmony export */ __webpack_require__.d(__webpack_exports__, {
          ...
          /* harmony export */ registerClientExtension: () =>
            /* binding */ registerClientExtension,
          /* harmony export */ registerClientPlugin: () =>
            /* binding */ registerClientPlugin,
          /* harmony export */ registerCloudBpmnJSModdleExtension: () =>
            /* binding */ registerCloudBpmnJSModdleExtension,
          /* harmony export */ registerCloudBpmnJSPlugin: () =>
            /* binding */ registerCloudBpmnJSPlugin,
          /* harmony export */ registerCloudDmnJSModdleExtension: () =>
            /* binding */ registerCloudDmnJSModdleExtension,
          /* harmony export */ registerCloudDmnJSPlugin: () =>
            /* binding */ registerCloudDmnJSPlugin,
          /* harmony export */ registerDmnJSModdleExtension: () =>
            /* binding */ registerDmnJSModdleExtension,
          /* harmony export */ registerDmnJSPlugin: () =>
            /* binding */ registerDmnJSPlugin,
          /* harmony export */ registerPlatformBpmnJSModdleExtension: () =>
            /* binding */ registerPlatformBpmnJSModdleExtension,
          /* harmony export */ registerPlatformBpmnJSPlugin: () =>
            /* binding */ registerPlatformBpmnJSPlugin,
          /* harmony export */ registerPlatformDmnJSModdleExtension: () =>
            /* binding */ registerPlatformDmnJSModdleExtension,
          /* harmony export */ registerPlatformDmnJSPlugin: () =>
            /* binding */ registerPlatformDmnJSPlugin,
          /* harmony export */
        });
        /**
        ...
        function registerPlatformBpmnJSPlugin(module) {
          registerClientPlugin(
            module,
            "bpmn.platform.modeler.additionalModules",
          );
        }
        ...
        function registerPlatformBpmnJSModdleExtension(descriptor) {
          registerClientPlugin(
            descriptor,
            "bpmn.platform.modeler.moddleExtension",
          );
        }
        ...
        function registerCloudBpmnJSModdleExtension(descriptor) {
          registerClientPlugin(
            descriptor,
            "bpmn.cloud.modeler.moddleExtension",
          );
        }
        ...
        function registerPlatformDmnJSModdleExtension(descriptor) {
          registerClientPlugin(
            descriptor,
            "dmn.platform.modeler.moddleExtension",
          );
        }
        ...
        function registerDmnJSPlugin(module, components) {
          ...
          components.forEach((c) =>
            registerClientPlugin(module, `dmn.modeler.${c}.additionalModules`),
          );
        }
        ...
        function registerCloudDmnJSPlugin(module, components) {
          ...
          components.forEach((c) =>
            registerClientPlugin(
              module,
              `dmn.cloud.modeler.${c}.additionalModules`,
            ),
          );
        }
        ...
        function registerPlatformDmnJSPlugin(module, components) {
          ...
          components.forEach((c) =>
            registerClientPlugin(
              module,
              `dmn.platform.modeler.${c}.additionalModules`,
            ),
          );
        }
  ...
  \**************************/
    __webpack_require__.r(__webpack_exports__);
    /* harmony import */ var camunda_modeler_plugin_helpers__WEBPACK_IMPORTED_MODULE_0__ =
      __webpack_require__(
        /*! camunda-modeler-plugin-helpers */ "./node_modules/camunda-modeler-plugin-helpers/index.js",
      );
    /* harmony import */ var bpmn_js_embedded_comments__WEBPACK_IMPORTED_MODULE_1__ =
      __webpack_require__(
        /*! bpmn-js-embedded-comments */ "./node_modules/bpmn-js-embedded-comments/dist/index.esm.js",
      );

    (0,
    camunda_modeler_plugin_helpers__WEBPACK_IMPORTED_MODULE_0__.registerBpmnJSPlugin)(
      bpmn_js_embedded_comments__WEBPACK_IMPORTED_MODULE_1__["default"],
    );
  })();
